...
NOTE: Not simple...and given that it is 2012 and there's no official support from Ruby, or Rails to connect with MS SQL, good luck... Using the compile information below it is possible to connect to MS SQL from CentOS, RedHat, and Mac OSX (that I've tested). However if the below doesn't work for you, I'd recommend creating a nightly dump of your MS SQL database to a MySQL database, and use {aqueduct-mysql}[https://github.com/remomueller/aqueduct-mysql] instead.
...
############ IMPORTANT!!!!
Two items to make solution work!
